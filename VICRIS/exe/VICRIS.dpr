...
uses
  ...
  udmBrAnalisiVendite in '..\DataModule\udmBrAnalisiVendite.pas' {dmBrAnalisiVendite: TdmDBRoot},
  uBrAnalisiVendite in '..\Src\uBrAnalisiVendite.pas' {fmBrAnalisiVendite: TfmRoot},
